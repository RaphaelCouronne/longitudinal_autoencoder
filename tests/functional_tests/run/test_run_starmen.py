...
class test_run_starmen(unittest.TestCase):
    ...
    def test_bvae(self):
        ...
        args.model_name = "BVAE"
        run_main(args)
        return 0

    def test_lssl(self):
        args = self.base_arguments()
        args.model_name = "VaeLSSL"
        run_main(args)
        return 0

    def test_drvae_setmean(self):
        args = self.base_arguments()
        args.pi_mode = "mean"
        args.model_name = "DRVAE"
        run_main(args)
        return 0

    def test_dvae_setmean(self):
        args = self.base_arguments()
        args.pi_mode = "mean"
        args.model_name = "DVAE"
        run_main(args)
        return 0

    def test_dvae_setidentity(self):
        args = self.base_arguments()
        args.pi_mode = "identity"
        args.model_name = "DVAE"
        run_main(args)
        return 0


    def test_longvae_setmean(self):
        args = self.base_arguments()
        args.pi_mode = "mean"
        args.model_name = "LongVAE"
        run_main(args)
        return 0


    def test_longvae_setidentity(self):
        args = self.base_arguments()
        args.pi_mode = "identity"
        args.model_name = "LongVAE"
        run_main(args)
    ...
    def test_regrvae(self):
        args = self.base_arguments()
        args.model_name = "BVAE_Regression"
        run_main(args)
        return 0

    def test_maxvae(self):
        args = self.base_arguments()
        args.model_name = "MaxVAE"
        run_main(args)
        return 0

    def test_mlvae(self):
        args = self.base_arguments()
        args.model_name = "MLVAE"
        run_main(args)
        return 0